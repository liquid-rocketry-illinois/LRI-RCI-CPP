...
//             tests[targetconfig["tests"][i]["id"].get<uint8_t>()] =
//             targetconfig["tests"][i]["name"].get<std::string>();
//         }
...
//                             data.title =
//                             targetconfig["windows"][i]["modules"][j]["ids"][k]["title"].get<std::string>();
//
//                             int devclass = targetconfig["windows"][i]["modules"][j]["ids"][k]["class"].get<int>();
//                             uint8_t channel =
//                             targetconfig["windows"][i]["modules"][j]["ids"][k]["channel"].get<uint8_t>();
//
//                             auto ids =
//                             targetconfig["windows"][i]["modules"][j]["ids"][k]["ids"].get<std::vector<uint8_t>>();
//
